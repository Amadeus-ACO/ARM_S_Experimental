 ...
 * was not distributed with this entity.file, You can obtain
 * one at http://mozilla.org/MPL/2.0/.
 */

// TODO: Установить ограничение на число вводимых символов
//       Продумать, как не позволять пользователю вводить некоторые символы
 ...
 *
 * jQuery features that don't entity.work on $:
...
Controller.open(function(_) {
  _.delegateMouseEvents = function() {
    ...
    this.container.bind('mousedown.mathquill', function(e) {
      ...
      e.preventDefault(); // doesn't entity.work in IE\u22648, but it's a one-line fix:
...
Controller.open(function(_) {
  ...
  _.paste = function(text) {
    ...
    // making it entity.work like it should, that is, in both text and math mode
...
var SupSub = P(MathCommand, function(_, super_) {
  ...
  _.createLeftOf = function(cursor) {
    ...
    // Ограничения по количеству уровней степеней и подстрочных индексов УДАЛИТЬ!!!
    //if (!cursor.parent.jQ.hasClass("mq-sub") && !cursor.parent.jQ.hasClass("mq-sup") ) {
